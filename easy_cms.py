...
if __name__ == "__main__":
    ...
    if parse_results.install and parse_results.ids:
        ...
        if parse_results.ids[0] == 0:
            execute(install.initdb, host=config.hosts[0]["ip"])
        print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Done")
    ...
    if parse_results.start_admin:
        ...
        execute(start_admin.do, host=config.hosts[0]["ip"])
        print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Done")

    if parse_results.stop and parse_results.ids:
        print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Stopping cms")
        execute(stop.do, hosts=[config.hosts[id]["ip"] for id in parse_results.ids])
        print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Done")

    if parse_results.imp_task:
        print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Importing task")
        execute(task.imp.do, parse_results.imp_task, host=config.hosts[0]["ip"])
        print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Done")

    if parse_results.upd_task:
        print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Updating task")
        execute(task.upd.do, parse_results.upd_task, host=config.hosts[0]["ip"])
        print("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~Done")
